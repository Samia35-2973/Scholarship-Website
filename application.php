...
session_start();
if (isset($_GET['scholarshipId']) && isset($_GET['studentId'])) {
...
<head>
    ...
    <title>Application - Scholars Journey</title>
...
<body>
    ...
    <main>
        <section class="tabs">
            <div class="container form-section">
                ...
                <div class="row g-5">
                    <div class="col-md-12">
                        <form action="php/application_process.php" method="POST" class="a-form" enctype="multipart/form-data">
                            <p>Personal Information</p>
                            <input type="hidden" name="scholarshipId" value="<?php echo $scholarshipId; ?>">
                            ...
                            <div class="row g-5">
                                <div class="col-md-6">
                                    <input type="text" name="degree" placeholder="Current Degree*" required
                                        id="user-degree">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" name="program" placeholder="Program*" required id="user-program">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6" style="display: flex;
                                justify-content: flex-start;">
                                    <p>Graduation*: <input type="date" id="graduation" name="grad-day"></p>
                                </div>
                                <div class="col-md-6">
                                    <input type="text" name="ins-country" placeholder="Country*" required
                                        id="ins-country">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" name="ins-zipcode" placeholder="Zip Code*" required
                                        id="ins-zipcode">
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row g-5">
                                <div class="col-md-6">
                                    <p style="text-align: start;">Upload CV*:</p>
                                    <input class="form-control" type="file" name="cv" id="cvFile">
                                </div>
                                <div class="col-md-6">
                                    <p style="text-align: start;">Upload Essay*:</p>
                                    <input class="form-control" type="file" name="essay" id="essayFile">
                                </div>
                                <div class="col-md-6">
                                    <p style="text-align: start;">Upload Recommendation Letter*:</p>
                                    <input class="form-control" type="file" name="ltr" id="recFile">
                                </div>
                                <div class="col-md-6">
                                    <p style="text-align: start;">Upload Transcripts*:</p>
                                    <input class="form-control" type="file" name="trans" id="resultFile">
                                </div>
                            </div>
                            <br>
                            ...
                            <p><input type="checkbox" name="terms" id="user-terms" value="agree"> I agree with the
                                terms and conditions as a Student. I have read the
                                terms and condition statement.</p>
                            <div class="d-flex flex-row justify-content-center">
                                <button data-bs-toggle="modal" data-bs-target="#updateAppModal" class="btn cus-btn"
                                    type="submit">APPLY</button>
                            </div>
                            <div class="d-flex flex-row justify-content-center">
                                <button data-bs-toggle="modal" data-bs-target="#deleteAppModal" class="btn cus-btn"
    ...
    <div class="modal" id="updateAppModal" tabindex="-1" aria-labelledby="updateAppModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateAppModalLabel">Application Saved</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal" id="deleteAppModal" tabindex="-1" aria-labelledby="deleteAppModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteAppModalLabel">Application is Deleted</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">OK</button>
