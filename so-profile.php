                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <?php
                        if(isset($_SESSION['login_done']) && isset($_SESSION['user_type'])){
                            ...
                            echo '<form method="POST" action="signup_redirect.php">
    ...
    <main>
        <section class="tabs">
            <div class="container form-section">
                <div class="row g-5">
                    <div class="col-md-12">
                        <h6>Scholarship Officer's Profile
                        </h6>
                    </div>
                </div>
                <?php
                    $myemail = $_SESSION['get_email'];
                    $display = "SELECT * FROM scholarship_officers WHERE email = '$myemail'";
                        ...
                        <form action="" class="a-form">
                            ...
                            <div class="row g-5">
                                <div class="col-md-6 cell-value">
                                    <!-- Officers Website -->
                                    <p>Website: </p>
                                    <p><p><?php echo $row["personal_website"]; ?></p></p>
                                </div>
                                <div class="col-md-6 cell-value">
                                    <!-- Officers Designation -->
                                    <p>Designation: </p>
                                    <p><p><?php echo $row["designation"]; ?></p></p>
                                </div>
                                <div class="col-md-6 cell-value">
                                    <!-- Officers Institute -->
                                    <p>Institute: </p>
                                    <p><p><?php echo $row["institute_name"]; ?></p></p>
                                </div>
                                <div class="col-md-6 cell-value">
                                    <!-- Officers Institute Address -->
                                    <p>Institute Address: </p>
                                    <p><p><?php echo $row["institute_address"]; ?></p></p>
                                </div>
                                <div class="col-md-6 cell-value">
                                    <!-- Officers Phone -->
                                    <p>Phone: </p>
                                    <p><p><?php echo $row["phone"]; ?></p></p>
                                </div>
                                <div class="col-md-6 cell-value">
                                    <!-- Officers Short Bio -->
                                    <p>Short Bio: </p>
                                    <p><p><?php echo $row["short_bio"]; ?></p></p>
                                </div>
                            </div>
                            <br>
                            <h6>Location</h6>
                            <div class="row g-5">
                                <div class="col-md-6 cell-value">
                                    <!-- Officers address -->
                                    <p>Address: </p>
                                    <p><p><?php echo $row["address"]; ?></p></p>
                                </div>
                                <div class="col-md-6 cell-value">
                                    <!-- Officers Country -->
                                    <p>Country: </p>
                                    <p><p><?php echo $row["country"]; ?></p></p>
                                </div>
                                <div class="col-md-6 cell-value">
                                    <!-- Officers Zipcode -->
                                    <p>Zipcode: </p>
                                    <p><p><?php echo $row["zip_code"]; ?></p></p>
                                </div>
                                <div class="col-md-6 cell-value">
                                    <!-- Officers City -->
                                    <p>City: </p>
                                    <p><p><?php echo $row["city"]; ?></p></p>
                                </div>
                            </div>
                            <br>
