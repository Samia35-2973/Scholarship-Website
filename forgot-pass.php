...
<head>
    ...
    <title>Forgot Password - Scholars Journey</title>
...
<body>
    ...
    <main>
        <section class="tabs">
            <div class="container form-section">
                ...
                <div class="row g-5">
                    <div class="col-md-12">
                        <form action="index.php" class="a-form">
                            <div class="row g-5">
                                <div class="col-md-12">
                            ...
                            <div class="d-flex flex-row justify-content-center">
                                <button data-bs-toggle="modal" data-bs-target="#forgotModal" class="btn cus-btn"
    ...
    <div class="modal" id="forgotModal" tabindex="-1" aria-labelledby="forgotModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="forgotModalLabel">Check Your Mail!</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-footer">
