...
<head>
    ...
    <title>Students Form - Scholars Journey</title>
        ...
        <section class="tabs">
            <div class="container form-section">
                ...
                <div class="row g-5">
                    <div class="col-md-12">
                        <div class="tab-1">
                            <form action="php/st_process_login.php" method="POST" class="a-form">
                                <div class="row g-5">
                                    <div class="col-md-12">
                                        <input type="text" name="user_mail" placeholder="Enter your email*" required
                                            id="userMail">
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="d-flex flex-row justify-content-center">
                                    ...
                                    <a class="btn cus-btn" href="forgot-pass.php">Forgot Password</a>
                                </div>
                            </form>
                        </div>
                        <div class="tab-2">
