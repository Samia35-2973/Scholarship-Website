...
<head>
    ...
    <title>Officer Dashboard - Scholars Journey</title>
    ...
    <header>
        ...
        <div class="container top-section">
            <div class="row">
                <div class="col-lg-6">
                    <div class="top-body">
                        <h1>Hi, Officer! Any New Scholarships available? If so, List now!</h1>
                        ...
                        <div class="input-group">
                            <a class="btn" href="add-scholarship.php">LIST SCHOLARSHIP</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">6.3/10.0</h5>
                    ...
                    <div class="col-md-6">
                        <img src="images/Your paragraph text.png" alt="" width="100%" class="shadow"
